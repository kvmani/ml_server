...
1. A browser sends a request to an endpoint such as `/pdf_tools/`,
   `/tabular_ml/`, or a linked companion service.
...
- **tabular_ml_service** – CPU-only table profiling, model training,
  evaluation, and inference integrated through the companion blueprint
